...
class JunkLeadsWidget extends StatefulWidget {
  @override
  _JunkLeadsWidgetState createState() => _JunkLeadsWidgetState();
}

class _JunkLeadsWidgetState extends State<JunkLeadsWidget> {
  @override
          ...
          child: Container(
            ...
            child: ListTile(
              ...
              trailing: Padding(
                ...
                child: Text("REJECTED",style: AppFontStyle.titleAppBarStyle(PRIMARY_COLOR),),
              ),
            ),
          ),
